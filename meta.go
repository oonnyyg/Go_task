...
// add returns a new Key with piece appended. It always allocates a fresh
// backing array because the result is stored in p.ordered while the receiver
// (p.context) is reused for the next key; reusing spare capacity via append
// would alias p.context and corrupt previously recorded keys.
